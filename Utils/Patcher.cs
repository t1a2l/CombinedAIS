...
namespace CombinedAIS.Utils
{
    ...
    {
        private const string HarmonyId = "t1a2l.CombinedAIS";
        ...
        public static void PatchAll()
        {
            ...
            UnityEngine.Debug.Log("Combined AIS: Patching...");

            patched = true;

            // Apply your patches here!
            // Harmony.DEBUG = true;
            var harmony = new Harmony("t1a2l.CombinedAIS");
        ...
        public static void UnpatchAll()
        {
            ...
            UnityEngine.Debug.Log("Combined AIS: Reverted...");
        }
    }
